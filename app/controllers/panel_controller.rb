...
#        end
  ...
  def select_set
    @sets = {
      "Anuncios (principal)": {
        model: Ad,
        fields: {titulo: "Título", texto: "Texto", link: "Liga", fecha: "Vigencia hasta", fecha_pub: "Fecha de publicación"},
        imgs: {imagen: "Imagen"},
        trix: []
        ...
        model: Tesis,
        fields: {ficha: "Ficha bibliográfica", anio: "Año de publicación", link: "Liga"},
        imgs: {},
        trix: [:ficha]
        ...
        model: Notice,
        fields: {ficha: "Ficha bibliográfica", link: "Liga"},
        imgs: {},
        trix: [:ficha]
        ...
        model: Capsule,
        fields: {titulo: "Título", fecha: "Fecha", autor: "Autor", abstract: "Reseña", link_vid: "Liga al video"},
        imgs: {},
        trix: [:abstract]
      }, "Documentales": {
        model: Documental,
        fields: {titulo: "Título", fecha: "Fecha", autor: "Autor", tipo: "Tipo de documental", abstract: "Reseña", link_vid: "Liga al video"},
        imgs: {},
        trix: [:abstract]
        ...
        imgs: {},
        trix: [:abstract]
      }, "Videos de foros y conferencias": {
        model: Forum,
        fields: {titulo: "Título", fecha: "Fecha", autor: "Autor", titulo_evento: "Título del evento", abstract: "Reseña", link_vids: "Liga al video", tit_vids: "Título de videos"},
        imgs: {},
        trix: [:abstract]
      }, "Enlaces de interés": {
        model: Link,
  ...
  def obj_params
    if params[:set] == "Anuncios (principal)"
      ...
      params.require(:tesis).permit(:ficha, :anio, :link)
      ...
      params.require(:notebook).permit(:ficha, :link)
    elsif params[:set] == "Cápsulas informativas"
      params.require(:capsule).permit(:titulo, :fecha, :autor, :abstract, :link_vid)
    elsif params[:set] == "Documentales"
      params.require(:documental).permit(:titulo, :fecha, :autor, :tipo, :abstract, :link_vid)
